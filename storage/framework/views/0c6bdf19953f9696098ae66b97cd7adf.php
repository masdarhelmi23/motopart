...
<?php endif; ?>
        ...
        <div class="mt-4 text-center">
            <p class="text-sm text-gray-600 dark:text-gray-400">
                ...
                <a href="<?php echo e(route('register')); ?>" class="text-indigo-600 hover:underline dark:text-indigo-400">
...
<?php endif; ?>
<?php /**PATH D:\software\MotoPart\resources\views/auth/login.blade.php ENDPATH**/ ?>